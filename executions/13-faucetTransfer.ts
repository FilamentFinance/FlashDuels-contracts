...
const main = async () => {
    ...
    console.log(await usdcContract.balanceOf("0x23bC3e7F43Fd7bD10aa27534ff11E871ac4B7C8E"))
    ...
    tx = await usdcContract.connect(deployer).transfer("0x23bC3e7F43Fd7bD10aa27534ff11E871ac4B7C8E", amount)
    await tx.wait(1)
