...
import {Betting} from "../contracts/MVP.sol";
...
contract CounterTest is Test {
    ...
    function test_basic() public {
        ...
        uint256[2] memory betammountfor1share_1 = getcurrentPrice(1);
        ...
        uint256[2] memory betammountfor1share_2 = getcurrentPrice(1);
        ...
        uint256[2] memory betammountfor1share_3 = getcurrentPrice(1);
        ...
        assertEq(
            makeAddr("cardHolder").balance, ((0.0004 ether + ((2 * 99 * betammountfor1share_2[1]) / 100)) * 20) / 100
        );
        assertEq(
            makeAddr("Better1onzero").balance,
            (99 * betammountfor1share_1[0]) / 100
                + ((0.0004 ether + 2 * ((99 * betammountfor1share_2[1]) / 100)) * 80) / 100
        );
    ...
    function test_Working_With_2_users() public {
        ...
        uint256[2] memory betammountfor1share_4 = getcurrentPrice(1);
        ...
        uint256 looseramount =
            0.0004 ether + ((betammountfor1share_4[1] * 99) / 100) + ((betammountfor1share_3[1] * 99) / 100);
